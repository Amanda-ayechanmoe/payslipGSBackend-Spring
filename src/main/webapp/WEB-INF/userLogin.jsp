...
.filter {
height: 100vh;
background: linear-gradient(to top right, rgb(50,205,50,0.8),gray) !important;
}
...
<div class="filter d-flex justify-content-center align-items-center">
	<div class="card p-3 d-flex flex-column justify-content-center align-items-center">
		<h1 class="my-3 font-weight-bold">Payslip<span style="color:limegreen;">GS</span>
		<br/><span class="subtitle"></span></h1>
		<form action="userRequest" method="post" class="form d-flex flex-column">
  			...
  			For employees,&nbsp;<span class="link" onclick="routeToAdmin()">sign-in here</span></div>
		</form>
	</div>
	</div>
</body>
